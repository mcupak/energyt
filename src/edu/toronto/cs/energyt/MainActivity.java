...
public class MainActivity extends Activity {
	...
	// These variables have to do with the implementation of energy efficient algorithm
	...
	// Objects in order to acquire info about signal strength, WiFi connection etc...
	public WifiManager wifi = null;
	public TelephonyManager cellSignal = null;
	
	// All threads are public because we want MainActivity to have full control upon
	...
	/**
	 * Listener: Base class for listening events. Other classes
	 * 			 listening classes inherit from it directly...
	 * @author michael
	 *
	 */
	...
	private class PlayListener extends Listener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			String currentLink = ((EditText)mainApp.findViewById(R.id.edtURL)).getText().toString();
...
//	private class CompletionListener extends Listener implements MediaPlayer.OnCompletionListener {
//
...
//				//the video... This means that streaming has ended -> Close all threads except
//				//the server socket
//				if (mainApp.video != null) {
//					mainApp.video.stopPlayback();
//					mainApp.video.seekTo(0);
...
//	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.cellSignal = (TelephonyManager)this.getSystemService(Context.TELEPHONY_SERVICE);
...
//	}
	...
	/**
	 * playVideo(): Triggers videoView to play the specific video
	 * the user demanded after prefetching has finished.
	 */
